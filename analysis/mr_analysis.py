...
def locationGraphIterator(minimumWeight=10): return (d for d in FileIO.iterateJsonFromFile(locationGraph) if d['w']>=minimumWeight)
...
#    plotLocationGraphEdgeDistribution()
    ...
    print len(list(locationGraphIterator()))