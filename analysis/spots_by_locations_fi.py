...
#    drawKMLsForUserBasedSpotsUsingFIClusters()
    drawKMLsForUserBasedDisjointFrequentLocationItemsets(minUserLocations=20, minCaluclatedSupport=minSupport, minLocationsInItemset=8, extraMinSupport=minSupport)    