...
#    plt.savefig('map.png')
    ...
    Map.onWorldMapPlot([
          ...
          ([-0.029000000000000001, -0.028000000000000001, -0.028000000000000001, -0.027, -0.027], [109.34099999999999, 109.342, 109.34099999999999, 109.34099999999999, 109.342], '#2a7958')
     ])
    plt.savefig('map.png')
