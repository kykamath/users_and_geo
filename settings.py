...
lidToNameMapFile = analysisFolder+'lidToNameMap'
...
regionsLlidsFile = hotspotsFolder + 'llids/%s'
...
latticeWithHashtags = twitterAnalysisFolder+'%s/latticeWithHashtags'
...
checkinSequenceLocationRegexFolder = checkinSequencesFolder+'locationRegex/'
checkinSequenceLocationRegexAnalysisFolder = checkinSequenceLocationRegexFolder + 'analysis/'